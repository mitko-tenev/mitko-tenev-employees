...
- Create Angular project with ng: `ng new mitko-tenev-employees.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`mitko-tenev-employees.client.esproj`).
